...
type Consumer interface {
	// Consume polls for new messages and if it Ffinds one, decodes it, sends it to the handler and deletes it
	//
	...
	//
	// Consume uses long-polling to check and retrieve messages, if it is unable to make a connection, the dynamox-SDK will use its
