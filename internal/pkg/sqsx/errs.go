...
var ErrInvalidCreds = newSQSErr("invalid sqsx credentials")
...
// ErrMessageProcessing occurs when a message has exceeded the consumption time limit set by dynamox SQS
